...
<div
    {{ $attributes->merge(['class' => 'max-w-sm mx-auto my-4 bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow duration-300']) }}>
    <div class="p-6">
